...
class TestMain(BaseTest):
    def test_instantiate_core(self):
        assert isinstance(TvRenamr('/', self.config), TvRenamr)
    ...
    def test_extracting_season_from_file_format_s0e00(self):
        season = self.tv.extract_details_from_file('chuck.s2e06.avi')['season']
        assert season == '2'

    def test_extracting_season_from_file_format_s00e00(self):
        season = self.tv.extract_details_from_file('chuck.s20e05.avi')['season']
        assert season == '20'
    ...
    def test_extracting_season_from_file_format_0x00(self):
        season = self.tv.extract_details_from_file('chuck.2x05.avi')['season']
        assert season == '2'

    def test_extracting_season_from_file_format_00x00(self):
        season = self.tv.extract_details_from_file('chuck.20x05.avi')['season']
        assert season == '20'
    ...
    def test_extracting_season_from_file_format_000(self):
        season = self.tv.extract_details_from_file('chuck.205.avi')['season']
        assert season == '2'

    def test_extracting_season_from_file_format_0000(self):
        season = self.tv.extract_details_from_file('chuck.2005.avi')['season']
        assert season == '20'
