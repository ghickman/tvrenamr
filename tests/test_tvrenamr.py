...
class TestScript(object):
    ...
    def test_single_rename_with_no_options(self):
        os.system('%s %s/chuck.s1e08.blah.HDTV.XViD.avi' % (self.base, self.working))
    ...
    def test_single_rename_with_rename_folder_location_specified(self):
        os.system('%s -r%s %s/chuck.s1e10.blah.HDTV.XViD.avi' % (self.base, self.renamed, self.working))
    ...
    def test_single_rename_with_rename_folder_location_specified_and_organise_option(self):
        os.system('%s -a -r%s %s/chuck.s1e11.blah.HDTV.XViD.avi' % (self.base, self.renamed, self.working))
    ...
    def test_single_rename_with_name_option(self):
        os.system('%s -n%s %s/chuck.s1e08.blah.HDTV.XViD.avi' % (self.base, '\'Stargate SG-1\'', self.working))
        assert_true(os.path.exists('%s/Stargate SG-1 - 108 - The Nox.avi' % self.working))
    
    def test_single_rename_with_season_option(self):
        os.system('%s -s2 %s/chuck.s1e08.blah.HDTV.XViD.avi' % (self.base, self.working))
    ...
    def test_single_rename_with_episode_option(self):
        os.system('%s -e9 %s/chuck.s1e08.blah.HDTV.XViD.avi' % (self.base, self.working))
    ...
    def test_single_rename_with_leading_the_moved_to_end_of_show_name_option(self):
        os.system('%s -t %s/The.Big.Bang.Theory.S03E01.HDTV.XViD-NoTV.avi' % (self.base, self.working))
    ...
    def test_single_rename_with_output_format_specified(self):
        os.system('%s -o%s %s/chuck.s1e08.blah.HDTV.XViD.avi' % (self.base, '\'%s%e - %n %t\'', self.working))
    ...
    def test_single_rename_with_exceptions_file_used(self):
        # os.system('%s -x%s %s/avatar.s1e08.blah.HDTV.XViD.avi' % (self.base, self.exceptions, self.working))
    ...
    def test_single_rename_with_deluge_option(self):
        # os.system('%s --deluge %s/chuck.s1e08.blah.HDTV.XViD.avi' % (self.base, self.working))
        # assert_true(os.path.exists('%s/Chuck - 108 - Chuck Versus the Truth.avi' % self.working))
        pass
    
    def test_single_rename_with_deluge_share_ratio_option(self):
        # os.system('%s --deluge-share-ratio%d %s/chuck.s1e08.blah.HDTV.XViD.avi' % (self.base, 2, self.working))
        # assert_true(os.path.exists('%s/Chuck - 108 - Chuck Versus the Truth.avi' % self.working))
        pass

    def test_single_rename_with_an_unexpected_format_raises_an_unexpected_format_exception(self):
        #assert_raises(UnexpectedFormatException, os.system('%s %s/\'West Wing.avi\'' % (self.base, self.working)))
        pass
