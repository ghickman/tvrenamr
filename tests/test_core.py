...
class TestCore(object):
    ...
    def test_setting_an_episodes_format_as_name_season_episode_title(self):
        ...
        credentials['show'] = title['show']
        credentials['title'] = title['title']
        assert_equals(self.tv.build_path(show=credentials['show'], season=credentials['season'], episode=credentials['episode'], title=credentials['title'], 
            extension=credentials['extension'], format='%n - %s%e - %t'), 'tests/data/working/Chuck - 108 - Chuck Versus the Truth.avi')
    ...
    def test_setting_an_episodes_format_as_season_episode_title_name(self):
        ...
        credentials['title'] = title['title']
        assert_equals(self.tv.build_path(show=credentials['show'], season=credentials['season'], episode=credentials['episode'], title=credentials['title'], 
            extension=credentials['extension'], format='%s - %e - %t - %n'), 'tests/data/working/1 - 08 - Chuck Versus the Truth - Chuck.avi')
    ...
    def test_setting_an_episodes_format_as_title_episode_season_name(self):
        ...
        credentials['title'] = title['title']
        assert_equals(self.tv.build_path(show=credentials['show'], season=credentials['season'], episode=credentials['episode'], title=credentials['title'], 
            extension=credentials['extension'], format='%t - %e - %s - %n'), 'tests/data/working/Chuck Versus the Truth - 08 - 1 - Chuck.avi')
