...
class TestAutoMoving(object):
    ...
    def test_using_organise_renames_the_file_correctly(self):
        ...
        path = self.tv.build_path(show=credentials['show'], season=credentials['season'], episode=credentials['episode'], title=credentials['title'], extension=credentials['extension'], organise=self.organise, renamed_dir=self.organised)
