...
Sometimes a file will be copied to the destination folder rather than moved, this seems to happen if large numbers of files are added to the watch
folder or files are added while others are still being renamed.