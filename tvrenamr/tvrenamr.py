...
parser.add_option('-l', '--log-file', dest='log_file', help='Set the log file location.')
parser.add_option('--log-level', dest='log', help='Set the log level. Options: debug, info, warning, error and critical.')
